...
<body>
    ...
    $room3 = new Room(300.99, 1, false, 11, $hotelmercure);
    ...
    $booking2 = new Booking($liamnelson, $room2, $hotelmercure, "2023-05-04", "2023-05-27");
    $booking3 = new Booking($vindiesel, $room5, $hotelmercure, "2023-05-07", "2023-05-29");
    $booking4 = new Booking($vindiesel, $room3, $hotelmercure, "2023-05-04", "2023-05-27");
    $booking5 = new Booking($vindiesel, $room3, $hotelmercure, "2023-05-10", "2023-05-24");
